...
public class IdentifiedIssueDTO extends UnidentifiedIssueDTO {
    ...
    private IdentifiedIssueDTO(long id, String summary, String description, Category category, Impact impact,
    ...
    public IdentifiedIssueDTO(long id, String summary, String description, Category category, Impact impact,
    ...
    public static IdentifiedIssueDTO completeIdentifiedIssueDTO(
        ...
        return new IdentifiedIssueDTO(id, summary, description, category, impact, status, dateClosed,
                project, owner);
    }
