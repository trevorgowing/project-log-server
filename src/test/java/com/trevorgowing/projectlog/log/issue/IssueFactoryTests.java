...
public class IssueFactoryTests extends AbstractTests {
  ...
  @InjectMocks private IssueFactory issueFactory;
  ...
  @Test
  public void
      testCreateIssueWithValidIssue_shouldDelegateToIssueRepositoryToSaveIssueAndReturnIssue() {
    // Set up fixture
    UnidentifiedIssueDTO unidentifiedIssueDTO =
        anUnidentifiedIssueDTO()
            .summary("Summary")
    ...
    when(issueRepository.save(argThat(samePropertyValuesAs(unidentifiedIssue))))
