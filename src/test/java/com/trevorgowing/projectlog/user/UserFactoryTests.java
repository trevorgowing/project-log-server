...
public class UserFactoryTests extends AbstractTests {
  ...
  public void
      testCreateUserWithDuplicateEmail_shouldDelegateToUserRepositoryAndThrowDuplicateEmailException()
          throws Exception {
    // Set up fixture
  ...
  @Test
  public void
      testCreateUserWithValidUser_shouldDelegateToUserRepositoryToSaveCreatedUserAndReturnManagedUser()
          throws Exception {
    // Set up fixture
    User unidentifiedUser =
        aUser()
