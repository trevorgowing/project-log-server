...
public class UserRetrieverTests extends AbstractTests {
  ...
  @InjectMocks private UserRetriever userRetriever;
  ...
  @Test
  public void
      testFindIdentifiedUserDTOs_shouldDelegateToUserRepositoryAndReturnIdentifiedUserDTOs() {
    // Set up fixture
  ...
  @Test(expected = UserNotFoundException.class)
  public void
      testFindIdentifiedUserDTOByIdWithNoMatchingUser_shouldDelegateToUserRepositoryAndThrowUserNotFoundException() {
    // Set up expectations
    when(userRepository.findIdentifiedUserDTOById(IRRELEVANT_USER_ID)).thenReturn(null);
  ...
  @Test
  public void
      testFindIdentifiedUserDTOByIdWithMatchingUser_shouldDelegateToUserRepositoryAndReturnIdentifiedUserDTO() {
    // Set up fixture
