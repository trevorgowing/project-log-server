...
public class UserModifierTests extends AbstractTests {
  ...
  public void
      testUpdateUserWithNoMatchingUser_shouldDelegateToUserRepositoryAndThrowUserNotFoundException() {
    // Set up expectations
  ...
  public void
      testUpdateUserWithDuplicateEmail_shouldDelegateToUserRepositoryAndThrowDuplicateUserException() {
    // Set up fixture
    User userWithDuplicateEmail =
        aUser()
    ...
    // Set up expectations
    when(userRetriever.findUser(IRRELEVANT_USER_ID)).thenReturn(userWithDuplicateEmail);
  ...
  public void testUpdateUserWithValidUser_shouldDelegateToUserRepositoryAndReturnUpdatedUser() {
    ...
    // Set up expectations
    when(userRetriever.findUser(IRRELEVANT_USER_ID)).thenReturn(expectedUser);
