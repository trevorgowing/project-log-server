...
public class ProjectModifierTests extends AbstractTests {
    ...
    public void testUpdateProjectWithDuplicateCode_shouldDelegateToProjectRepositoryAndThrowDuplicateProjectCodeException() {
        ...
        // Set up expectations
        when(projectRetriever.findProject(IRRELEVANT_PROJECT_ID))
        ...
        // Exercise SUT
        projectModifier.updateProject(IRRELEVANT_PROJECT_ID, duplicateCode, IRRELEVANT_PROJECT_NAME,
    ...
    public void testUpdateProjectWithNonExistentUser_shouldDelegateToUserCRUDServiceAndThrowUserNotFoundException() {
        ...
        // Exercise SUT
        projectModifier.updateProject(IRRELEVANT_PROJECT_ID, IRRELEVANT_PROJECT_CODE, IRRELEVANT_PROJECT_NAME,
    ...
    public void testUpdateProjectWithValidProject_shouldDelegateToProjectRepositoryAndReturnUpdatedProject() {
        ...
        // Exercise SUT
        Project actualProject = projectModifier.updateProject(IRRELEVANT_PROJECT_ID, IRRELEVANT_PROJECT_CODE, IRRELEVANT_PROJECT_NAME,
