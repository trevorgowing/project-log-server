...
public class ProjectRetrieverTests extends AbstractTests {
	...
	public void testGetIdentifiedProjectDTOs_shouldDelegateToProjectRepositoryAndReturnIdentifiedProjectDTOs() {
		...
		// Exercise SUT
		List<IdentifiedProjectDTO> actualIdentifiedProjectDTOs = projectRetriever.getIdentifiedProjectDTOs();
	...
	public void testGetIdentifiedProjectDTOByIdWithMatchingProject_shouldReturnProject() {
		...
		// Exercise SUT
		IdentifiedProjectDTO actualIdentifiedProjectDTO = projectRetriever.getIdentifiedProjectDTOById(
